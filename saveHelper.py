...
class saverObject:
    ...
    def cache_test_pictures(self, subfolders, path = None,offset = 0):
        if path is None:
            path = self.origin_folder
        listPaths = []
    ...
    def random_test_batch(self,batch_size):
        ...
        data,classes,one_hot_classes = self._load_data("test_batch_" + str(random.randint(0,self.num_test_batches))+ ".pkl")
